...
### 3.  **Add Data** 
Place your raw `.EDF` files in the `./input_data/` directory.
...
Runs one participant at a time, not integrated with the rest of the pipeline - just leaving the code here in case it is useful in the future.
```
